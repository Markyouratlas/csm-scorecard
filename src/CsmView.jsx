  ...
  useEffect(() => {
    ...
    supabase
      ...
      .then(async ({ data, error }) => {
        ...
        // First-time open of the CSM's OWN current week (no row existed yet):
        ...
        // where the CSM deliberately cleared the list is never re-seeded.
        if (!data && !isExecDrillIn && weekKey === currentWeekKey) {
          ...
          // Most recent prior week that has at least one named customer.
